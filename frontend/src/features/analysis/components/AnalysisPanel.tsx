...
export const AnalysisPanel = ({
  ...
  return (
    <div className="analysis-panel" data-ui-id={UI_IDS.ANALYSIS_PANEL}>
      {/* Header */}
      <div className="analysis-panel-header" data-ui-id={UI_IDS.ANALYSIS_PANEL_HEADER}>
      ...
      {/* Variations */}
      {variations.length > 0 ? (
        <ol className="analysis-panel-variations" data-ui-id={UI_IDS.ANALYSIS_PANEL_VARIATIONS}>
          {variations.map((v) => (
            <li
              key={v.multipvIndex}
