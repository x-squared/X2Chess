...
export const selectActiveDevTab = (state: AppStoreState): "ast" | "pgn" => state.activeDevTab;
...
export const selectActiveSourceKind = (state: AppStoreState): string => state.activeSourceKind;
export const selectBoardPreview = (state: AppStoreState): { fen: string; lastMove?: [string, string] | null } | null =>
  state.boardPreview;
export const selectPositionPreviewOnHover = (state: AppStoreState): boolean => state.positionPreviewOnHover;
...
export const selectSessions = (state: AppStoreState): SessionItemState[] => state.sessions;
