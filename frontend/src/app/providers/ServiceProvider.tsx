...
const defaultServices: AppStartupServices = {
  ...
  undo: noop,
  redo: noop,
  recordHistorySnapshot: noop,
  openGameFromRef: noop,
  openResource: noop,
  openResourceFile: noop,
  openResourceDatabase: noop,
  openResourceDirectory: noop,
  createResource: noop,
  selectResourceTab: noop,
  closeResourceTab: noop,
  deleteActiveGameInResource: async (): Promise<void> => {},
  openNewGameDialog: noop,
  newGameInActiveResource: async (): Promise<void> => {},
  openPgnText: noop,
  ...
  fetchGameMetadataByRecordIdInResource: async (): Promise<Record<string, string> | null> => null,
  ...
  notifySessionItemsChanged: noop,
