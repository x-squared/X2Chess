...
- **New-game save**: If the session has no `sourceRef`, `ensureSourceForActiveSession` creates a new game record in the currently active resource tab before saving.
