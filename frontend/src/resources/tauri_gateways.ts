/**
 * tauri_gateways — Tauri runtime detection and gateway builders.
 *
 * Provides `isTauriRuntime`, `buildTauriFsGateway`, and `buildTauriDbGateway`
 * so they can be shared between `source_gateway.ts` and other modules that
