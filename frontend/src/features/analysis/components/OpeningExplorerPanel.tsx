...
export const OpeningExplorerPanel = ({
  ...
  return (
    <div className="opening-explorer-panel" data-ui-id={UI_IDS.OPENING_EXPLORER_PANEL}>
      {/* Header */}
      <div className="opening-explorer-header" data-ui-id={UI_IDS.OPENING_EXPLORER_HEADER}>
          ...
          {!isLoading && result && (
            <>
              ...
              {result.moves.length > 0 && (
                <table className="opening-moves-table" data-ui-id={UI_IDS.OPENING_MOVES_TABLE}>
                  <thead>
                    <tr>
