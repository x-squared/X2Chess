...
test("REPLAY_PROTOCOL.summarize — returns correct summary", () => {
  ...
  transcript = addPlyRecord(transcript, { ply: 1, sourceMoveUci: "e7e5", sourceMoveSan: "e5", outcome: "wrong", attemptsCount: 2, timeTakenMs: 1200 });
  ...
  // Score: 3 correct out of 3+1 scored = 75%
